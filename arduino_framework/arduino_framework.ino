...
int p[NP] = {  }; //analog input pins
int pv[NP];//pot value
int ppv[NP] = {}; //previous pot value

//buttons
//int nb = 7;
int b[] = { 2 }; //digital input pins
boolean bg[] = {true};//momentary button gates
////button toggle
int btv[] = { 0 }; //toggle button current value
int btamt[] = { 2 }; //number of toggles
boolean btg[] = {true};//toggle button gates
